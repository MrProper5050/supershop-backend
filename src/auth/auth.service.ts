...
export class AuthService {
    ...
    async loginUser(loginUserDto: LoginUserDto) {
        ...
        const {username, email, balance, createdAt, id, purchasedGoods, myGoods, role} = user
        const payload = { id, username, email, balance, createdAt, purchasedGoods, myGoods, role }
